...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        ...
        $sql = "SELECT id FROM loginsys WHERE username = :username";
    ...
    if (empty(trim($_POST["email"]))) {
        ...
        $sql = "SELECT id FROM loginsys WHERE email = :email";
    ...
    if (empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        $sql = "INSERT INTO loginsys (username, email, password) VALUES (:username, :email, :password)";
